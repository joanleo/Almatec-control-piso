    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                .authorizeRequests(requests -> requests
                		...
                		.antMatchers("/comercial/pedidos/listar").hasAuthority("ACCESS_PEDIDOS")
                        .antMatchers("/comercial/pedidos/estado/**").hasAuthority("ACCESS_ESTADO_PEDIDOS")
                        ...
                        .antMatchers("/programacion/prioridades").hasAuthority("ACCESS_PRIORIDAD")
                        ...
                        .antMatchers("/produccion/home").hasAuthority("ACCESS_PLANTA")
                        .antMatchers("/centros-trabajo/carga").hasAuthority("ACCESS_CARGA_X_CT")
                        ...
                        .antMatchers("/produccion/resumen-materia-prima-op").hasAuthority("ACCESS_GENERAR_INFORME_KG_CENTRO_TRABAJO")
                        .antMatchers("/almacen/solicitudes/historial").hasAuthority("ACCESS_VER_HISTORIAL_SOLICITUDES_MATERIA_PRIMA")
                        .antMatchers("/almacen/detalle/**").hasAnyAuthority("ACCESS_VER_SOLICITUDES_DE_MATERIA_PRIMA", "ACCESS_VER_HISTORIAL_SOLICITUDES_MATERIA_PRIMA")
