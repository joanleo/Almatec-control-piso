...
public class DoctoentregasDocumentosVersión02 implements Conector {
	...
	private Integer f350_id_clase_docto;  //720=Entregas de producción
	...
	private String f350_id_motivo_consuno;  //Valida en maestro, código de motivo. Solo aplica para posdeducción y no es obligatorio.
	private String f350_id_proyecto_consumo;  //Valida en maestro, código de proyecto del movimiento. Solo aplica para posdeducción y no es obligatorio.
	private String f350_id_ccosto_consumo;
	...
	public String getF350_id_motivo_consuno () {
		return getFormattedValue(f350_id_motivo_consuno ,2);
	}

	public void setF350_id_motivo_consuno (String f350_id_motivo_consuno) {
		this.f350_id_motivo_consuno = f350_id_motivo_consuno;
	}

	public String getF350_id_proyecto_consumo () {
		return getFormattedValue(f350_id_proyecto_consumo ,15);
	}

	public void setF350_id_proyecto_consumo (String f350_id_proyecto_consumo) {
		this.f350_id_proyecto_consumo = f350_id_proyecto_consumo;
	}	

	public String getF350_id_ccosto_consumo() {
		return getFormattedValue(f350_id_ccosto_consumo ,15);
	}
	
	public void setF350_id_ccosto_consumo(String f350_id_ccosto_consumo) {
		this.f350_id_ccosto_consumo = f350_id_ccosto_consumo;
	}
	
	public DoctoentregasDocumentosVersión02 () {
